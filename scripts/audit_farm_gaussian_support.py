...
try:
    from scripts.refine_farm_object_geometry import _load_frames, _numpy, _observation_points
except ModuleNotFoundError:  # Direct script execution adds scripts/ to sys.path.
    from refine_farm_object_geometry import _load_frames, _numpy, _observation_points
