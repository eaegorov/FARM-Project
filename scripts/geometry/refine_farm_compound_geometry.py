...
try:
    from scripts.geometry.farm_geometry_axes import add_up_arguments, policy_from_args, write_state_up_policy
except ModuleNotFoundError:  # package import: scripts.geometry.refine_farm_compound_geometry
    from scripts.geometry.farm_geometry_axes import add_up_arguments, policy_from_args, write_state_up_policy
