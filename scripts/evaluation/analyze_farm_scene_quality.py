...
try:
    from scripts.geometry.farm_geometry_axes import horizontal_plane_basis, normalize_up_vector, resolve_up_policy
except ModuleNotFoundError:  # package import: scripts.evaluation.analyze_farm_scene_quality
