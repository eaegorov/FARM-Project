...
except ModuleNotFoundError:  # package import: scripts.build_farm_object_assemblies
...
def _merge_mask_files(source_paths: list[Path], destination: Path) -> int:
    ...
    return int(crop_payload["crop_jpeg_bytes"].size)
...
def main() -> int:
    ...
    for members, relations in groups:
        ...
        for image_id in merged_image_ids:
            ...
            crop_bytes_len = _merge_mask_files(
            ...
            representative["crop_jpeg_bytes_len"] = crop_bytes_len
