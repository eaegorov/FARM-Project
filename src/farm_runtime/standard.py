...
STANDARD_STAGE_CODE_INPUTS: dict[str, tuple[str, ...]] = {
    ...
    "selection": ("scripts/select_colmap_keyframes.py",),
    "rgbd": ("scripts/prepare_colmap_3dgs_rgbd.py",),
    "mapping": (
        "docker/entrypoint.sh",
        "configs/yoloe_vocabulary.txt",
        "scripts/build_farm_adaptive_vocabulary.py",
    ...
    "mapping_qa": (
        "scripts/analyze_farm_scene_quality.py",
        "scripts/farm_geometry_axes.py",
    ),
    "presentation": ("scripts/prepare_farm_presentation.py",),
    "geometry": (
        "scripts/refine_farm_object_geometry.py",
        "scripts/farm_geometry_axes.py",
        "scripts/plot_farm_geometry_audit.py",
        "scripts/plot_farm_obb_reprojections.py",
        "src/scene_graph/map_update/mask_observations.py",
    ),
    "visual_consistency": (
        "scripts/refine_farm_visual_consistency.py",
    ...
    "semantics": (
        ...
        "scripts/prepare_farm_presentation.py",
    ...
    "part_whole": (
        "scripts/analyze_farm_part_whole.py",
        "scripts/apply_farm_full_colmap_rescue.py",
        "scripts/merge_farm_full_colmap_rescue.py",
        "scripts/plan_farm_full_colmap_rescue.py",
        "scripts/prepare_colmap_3dgs_rgbd.py",
        "scripts/refine_farm_full_colmap_masks.py",
        "scripts/refine_farm_object_geometry.py",
        "scripts/review_farm_object_crops.py",
        "scripts/start_farm_vllm.sh",
    ...
    "assemblies": (
        "scripts/build_farm_object_assemblies.py",
        "scripts/review_farm_object_crops.py",
        "scripts/refine_farm_object_geometry.py",
        "scripts/enrich_farm_embeddings.py",
        "scripts/farm_geometry_axes.py",
        "scripts/start_farm_vllm.sh",
        "src/scene_graph/captioning/evidence.py",
        "src/scene_graph/captioning/label_contract.py",
    ...
    "compound_geometry": (
        "scripts/refine_farm_compound_geometry.py",
        "scripts/refine_farm_compound_presentation.py",
        "scripts/refine_farm_object_geometry.py",
        "scripts/farm_geometry_axes.py",
    ),
    "geometry_qa": ("scripts/validate_farm_geometry.py",),
    "dedup": (
        "scripts/unify_farm_compound_presentation.py",
        "scripts/resolve_farm_track_duplicates.py",
    ),
    "finalize": (
        "scripts/build_farm_tiered_state.py",
        "scripts/build_farm_final_acceptance.py",
        "src/farm_pipeline/final_acceptance.py",
        "src/scene_graph/captioning/evidence.py",
    ),
    "qa_bundle": (
        "scripts/build_farm_run_report.py",
        "scripts/build_farm_retention_funnel.py",
        "scripts/analyze_farm_scene_quality.py",
